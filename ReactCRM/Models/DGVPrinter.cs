...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Segoe Print", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Segoe Print", 18, FontStyle.Regular, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("Segoe Print", 10, FontStyle.Regular, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Segoe Print", 10, FontStyle.Regular, GraphicsUnit.Point);
